...
const byte interruptPin = 13; // Pino que Sera conectado o medidor de fluxo
...
void setup()
{
  ...
  pinMode(13, INPUT);
  //pinMode(3, INPUT);
  //attachInterrupt(digitalPinToInterrupt(2), incpulso, RISING); //Configura o pino 2(Interrupção 0) para trabalhar como interrupção
  attachInterrupt(digitalPinToInterrupt(interruptPin), incpulso, RISING); //Configura o pino 2(Interrupção 0) para trabalhar como interrupção
