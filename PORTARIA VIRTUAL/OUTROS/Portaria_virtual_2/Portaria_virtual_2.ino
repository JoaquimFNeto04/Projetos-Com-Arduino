...
void setup()
{
  ...
  Serial.println("PORTARIA VIRTUAL"); 
    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == 'n')
        {
          ...
          client.println("<html>");
          client.println("<head>");
          client.println("<title>Portaria Virtual</title>");
          client.println("<meta http-equiv='Content-Type' content='text/html; charset=ISO-8859-1'>");
          client.println("<meta name='viewport' content='width=720, initial-scale=0.5' />");
          client.println("<link rel='stylesheet' type='text/css' href='http://automacao.grupo2g.com.br/automacao_triade.css' />");
          client.println("<script type='text/javascript' src='https://http://automacao.grupo2g.com.br/automacao_triade.js'></script>");
          client.println("</head>");
          client.println("<body>");
          client.println("<div id='wrapper'><img alt='FILIPEFLOP' src='http://automacao.grupo2g.com.br/Imagens/log2.png'/><br/>");
