/*--------------------------------------------------------------
  Programa:      web_server_hw_button_pg_button

  Modificad:     Eng. Carlos Kwiek em 23/11/2015

  Descricao:  Arduino Permite controlar uma porta via caixa checkbox
                e outra porta via botao
                
  Hardware:     Arduino Uno oficial e Arduino Ethernet
                shield com SD card. 
                Portas nos pinos 6 e 7.
                Pushboton nos pinos 2 e 3.
                
  Software:     
                SD card de boa qualidade formatado para FAT16
                o arquivo pagina web chamado index.htm deve ser carreagado
                no SDcard
                
  
  Referencia:   Meus agradecinetos ao autor do projeto original
...
IPAddress ip(192, 168, 1, 17); // Aqui coloque seu endereco IP
