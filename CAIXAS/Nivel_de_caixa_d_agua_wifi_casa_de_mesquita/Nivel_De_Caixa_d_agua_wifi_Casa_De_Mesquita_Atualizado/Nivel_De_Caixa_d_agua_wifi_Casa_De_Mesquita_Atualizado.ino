// CASA DE PONTA NEGRA DE MESQUITA
...
char auth[] = "4Je_XhdhxBL6Oj46BpMUFr1M_EtiRSK8";
...
void loop() {
  ...
  if (controle == 5) {
    ...
    Blynk.email("superboxmf@hotmail.com", "CAIXA DE AGUA DE DEDEI", "A CAIXA D'AGUA DE DEDEI ESTA NO NIVEL BAIXO FAVOR PROVIDENCIAR O ABSTECIMENTO");X
  }
  if ((controle >= 51) and (controle % 60 == 0) or (controle == 54)) {
    Blynk.notify(" A CAIXA ESTA COM NIVEL CRITICO");
    Blynk.email("superboxmf@hotmail.com", "CAIXA DE AGUA DE DEDEI", "A CAIXA D'AGUA DE DEDEI ESTA NO NIVEL CRITICO FAVOR PROVIDENCIAR O ABSTECIMENTO");
  }
